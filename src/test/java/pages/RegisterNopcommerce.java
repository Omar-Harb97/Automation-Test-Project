...
public class RegisterNopcommerce {
    ...
    public RegisterNopcommerce(WebDriver _driver) {
        this.driver = _driver;
    }

    //didn't exist on this site anymore
    ...
    public void insertName(String firstName, String lastName, String email) {
    ...
    public void insertPass( String password, String confirmationPass) {
        this.driver.findElement(this.passwordField).sendKeys(new CharSequence[]{password});
        this.driver.findElement(this.confirmationField).sendKeys(new CharSequence[]{confirmationPass});
    }
